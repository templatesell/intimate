<?php
/**
 * Intimate Featured Post Widget.
 *
 * @since 1.0.0
 */
if (!class_exists('Intimate_Recent_Post_Sidebar')) :
     ...
     * @since 1.0.0
     */
    class Intimate_Recent_Post_Sidebar extends WP_Widget
    {
        ...
        {
            $opts = array(
                'classname' => 'intimate-featured-post-sidebar',
                'description' => esc_html__('Displays Featured Post in Sidebars. Place it in Sidebar Widget Area.', 'intimate'),
            );

            parent::__construct('intimate-featured-post-sidebar', esc_html__('Intimate Recent Post Sidebar', 'intimate'), $opts);
        }
        ...
        public function form($instance)
        {
            ...
            <p>
                <label
                for="<?php echo esc_attr($this->get_field_id('title')); ?>"><?php esc_html_e('Title:', 'intimate'); ?></label>
