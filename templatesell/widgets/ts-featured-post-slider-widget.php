 ...
 * @since 1.0.0
 */
if (!class_exists('Intimate_Featured_Post_Slider')) :
     ...
     * @since 1.0.0
     */
    class Intimate_Featured_Post_Slider extends WP_Widget
    {

         private function defaults()
        {
            $defaults = array(
            'title' => esc_html__('Featured Posts Slider', 'intimate' ),
            'cat' => 0,
            'post-number' => 5,
           );
        return $defaults;
        ...
        {
            $opts = array(
                'classname' => 'intimate-featured-post-slider',
                'description' => esc_html__('Display post in Grid Form. Suitable on Sidebars.', 'intimate'),
            );

            parent::__construct('intimate-featured-post-slider', esc_html__('Intimate Featured Post Slider', 'intimate'), $opts);
        }
